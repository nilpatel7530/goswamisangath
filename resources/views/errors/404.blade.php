...
@section('title', 'Page Not Found - ' . ($siteSettings->site_name ?? 'GoswamiSangath'))
...
<div class="min-h-[70vh] flex items-center justify-center px-4 py-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-400">
    <div class="max-w-md w-full text-center slide-up">
        <div class="relative mb-8">
            <h1 class="text-[12rem] font-bold text-gray-200 dark:text-gray-800 leading-none select-none">404</h1>
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center animate-pulse">
        ...
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">
            {{ __('common.page_not_found') ?? 'Page Not Found' }}
        </h2>
        
        <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-sm mx-auto">
            {{ __('common.404_msg') ?? "The page you're looking for doesn't exist or has been moved." }}
        </p>
