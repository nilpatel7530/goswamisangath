...
<head>
    ...
    <title>{{ __('Privacy Policy') }} - {{ $siteSettings->site_name ?? 'GoswamiSangath' }}</title>
    ...
    <style>
        ...
        .prose h2 { font-size: 1.875rem; font-weight: 700; color: white; margin-top: 2rem; margin-bottom: 1rem; }
        .prose p { color: #b9a19d; font-size: 1.125rem; line-height: 1.75; margin-bottom: 1rem; }
        .prose ul { list-style-type: disc; margin-left: 1.5rem; color: #b9a19d; margin-bottom: 1.5rem; }
    ...
    <div class="relative flex h-auto min-h-screen w-full flex-col">
                    ...
                    <div class="flex flex-col gap-12 lg:gap-20">
                        ...
                        <div class="flex flex-col gap-6 max-w-4xl">
                            <h1 class="text-slate-900 dark:text-white text-5xl lg:text-7xl font-black leading-[1.1] tracking-[-0.033em]">
                                <span data-translate="Privacy Policy">{{ __('Privacy Policy') }}</span>
                            </h1>
                            <p class="text-slate-600 dark:text-white/70 text-lg lg:text-2xl font-normal leading-relaxed max-w-2xl" data-translate="Your privacy is important to us. Learn how we handle your data with care and transparency.">
                                {{ __('Your privacy is important to us. Learn how we handle your data with care and transparency.') }}
                            </p>
        ...
        <div class="px-6 lg:px-40 flex flex-1 justify-center py-12 bg-background-light dark:bg-background-dark">
            <div class="layout-content-container flex flex-col max-w-[1200px] flex-1 gap-12">
                @if(isset($siteSettings->privacy_content) && $siteSettings->privacy_content)
                    <div class="prose dark:prose-invert max-w-none text-slate-700 dark:text-[#b9a19d]">
                        {!! $siteSettings->privacy_content !!}
                    </div>
                @else
                    <div class="flex flex-col items-center justify-center py-20 text-center gap-6">
                        ...
                        <p class="text-slate-500 dark:text-[#b9a19d] max-w-sm">{{ __('No privacy policy content found. Please update the content in the admin settings panel.') }}</p>
        ...
        <div class="px-6 lg:px-40 py-24 flex justify-center bg-background-light dark:bg-background-dark relative overflow-hidden">
            ...
            <div class="layout-content-container flex flex-col items-center max-w-[800px] text-center gap-8 relative z-10">
                ...
                <p class="text-slate-600 dark:text-white/60 text-xl max-w-xl">
                    If you have any questions about our Privacy Policy, please don't hesitate to reach out to our team.
                </p>
